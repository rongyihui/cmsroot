...
<head>
    ...
    <script>
        ...
        layui.use(['form', 'layer', 'element','cmsCore'], function () {
            ...
            cmsCore.submitData('/cms/admin/group',index,'put');
...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
    <legend>修改用户组：${group.name}</legend>
</fieldset>
    ...
    <form class="layui-form layui-form-pane" lay-filter="fromUpdate">
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="name" lay-verify="required" placeholder="请输入用户组名称"
                           autocomplete="off"
                           class="layui-input">
                </div>
            </div>
        ...
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="intro" lay-verify="required" placeholder="请输入用户组介绍"
